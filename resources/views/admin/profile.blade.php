    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="{{asset('admin/assets/images/users/'.$data->avatar)}}" class="rounded-circle" width="150" />
                    ...
                    <div class="card-body">
                        ...
                        <form  class="form-horizontal form-material" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="file"  class="form-control form-control-line" value="{{$data->avatar}}" name="avatar">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="danang-vietnam" class="form-control form-control-line" id="example-email" value="{{$data->address}}" name="address" >
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="123 456 7890" class="form-control form-control-line" value="{{$data->phone}}" name="phone">
                                </div>
                            </div>
                            <div class="form-group">
